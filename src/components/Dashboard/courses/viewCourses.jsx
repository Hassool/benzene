...
export default function ViewCourses() {
  ...
  const handleDelete = async (courseId) => {
    if (!confirm("Are you sure you want to delete this course? This action cannot be undone and will delete all sections, resources, and associated data.")) {
      return
    }
    ...
    try {
      ...
      // Remove the course from local state only after successful deletion
      setCourses((prev) => prev.filter((c) => c._id !== courseId))
      
      // Log success with deletion statistics if available
    ...
    return (
      <div className="min-h-screen bg-gradient-light dark:bg-gradient-dark flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <p className="text-text-secondary dark:text-text-dark-secondary">Loading your courses...</p>
        </div>
      </div>
    )
  }
              ...
              >
                <div className="flex gap-6">
                  ...
                  <div className="relative overflow-hidden rounded-xl shrink-0">
                    ...
                    />
                    {/* Loading overlay for deleting course */}
                    ...
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <div className="flex gap-2 opacity-75 group-hover:opacity-100 transition-opacity duration-200">
                        ...
                        <button
                          ...
                          title={deletingCourseId === course._id ? "Deleting..." : "Delete Course"}
                        >
                          {deletingCourseId === course._id ? (
